...
## 🡱 Facing North 🡱
# Car - Frame
fill -1 64 -2 1 64 3 minecraft:wooden_slab[type=top] 5
# Car - Tires
...
# Car - Door Handles
setblock -2 65 0 minecraft:wooden_button[facing=west]
setblock 2 65 0 minecraft:wooden_button[facing=east]
# Car - Engine
setblock 0 65 -2 minecraft:anvil[facing=north]
# Car - Horn
setblock 0 65 0 minecraft:polished_blackstone_button[facing=south]
# Car - Head Lights
setblock -1 65 -3 minecraft:wooden_button[facing=north]
setblock 0 65 -3 minecraft:wall_sign[facing=north]{Text1:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text2:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text3:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text4:'"|||||||||||||||||||||||||||||||||||||||||||||"'}
setblock 1 65 -3 minecraft:wooden_button[facing=north]
# Car - Tail Lights
setblock 1 65 4 minecraft:wooden_button[facing=south]
setblock 0 64 4 minecraft:wall_sign[facing=south]{Text2:'"MYSTICAT"'}
setblock -1 65 4 minecraft:wooden_button[facing=south]
# Car - Racing Stripe
...
## 🡳 Facing South 🡳
# Car - Frame
fill -1 69 -2 1 69 3 minecraft:wooden_slab[type=top] 5
# Car - Tires
...
# Car - Door Handles
setblock -2 70 1 minecraft:wooden_button[facing=west]
setblock 2 70 1 minecraft:wooden_button[facing=east]
# Car - Engine
setblock 0 70 3 minecraft:anvil[facing=south]
# Car - Horn
setblock 0 70 1 minecraft:polished_blackstone_button[facing=north]
# Car - Head Lights
setblock 1 70 4 minecraft:wooden_button[facing=south]
setblock 0 70 4 minecraft:wall_sign[facing=south]{Text1:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text2:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text3:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text4:'"|||||||||||||||||||||||||||||||||||||||||||||"'}
setblock -1 70 4 minecraft:wooden_button[facing=south]
# Car - Tail Lights
setblock -1 70 -3 minecraft:wooden_button[facing=north]
setblock 0 69 -3 minecraft:wall_sign[facing=north]{Text2:'"MYSTICAT"'}
setblock 1 70 -3 minecraft:wooden_button[facing=north]
# Car - Racing Stripe
...
## 🡲 Facing East 🡲
# Car - Frame
fill 2 74 -1 -3 74 1 minecraft:wooden_slab[type=top] 5
# Car - Tires
...
# Car - Door Handles
setblock 0 75 -2 minecraft:wooden_button[facing=north]
setblock 0 75 2 minecraft:wooden_button[facing=south]
# Car - Engine
setblock 2 75 0 minecraft:anvil[facing=east]
# Car - Horn
setblock 0 75 0 minecraft:polished_blackstone_button[facing=west]
# Car - Head Lights
setblock 3 75 -1 minecraft:wooden_button[facing=east]
setblock 3 75 0 minecraft:wall_sign[facing=east]{Text1:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text2:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text3:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text4:'"|||||||||||||||||||||||||||||||||||||||||||||"'}
setblock 3 75 1 minecraft:wooden_button[facing=east]
# Car - Tail Lights
setblock -4 75 1 minecraft:wooden_button[facing=west]
setblock -4 74 0 minecraft:wall_sign[facing=west]{Text2:'"MYSTICAT"'}
setblock -4 75 -1 minecraft:wooden_button[facing=west]
# Car - Racing Stripe
...
## 🡰 Facing West 🡰
# Car - Frame
fill 2 79 -1 -3 79 1 minecraft:wooden_slab[type=top] 5
# Car - Tires
...
# Car - Door Handles
setblock -1 80 2 minecraft:wooden_button[facing=south]
setblock -1 80 -2 minecraft:wooden_button[facing=north]
# Car - Engine
setblock -3 80 0 minecraft:anvil[facing=west]
# Car - Horn
setblock -1 80 0 minecraft:polished_blackstone_button[facing=east]
# Car - Head Lights
setblock -4 80 1 minecraft:wooden_button[facing=west]
setblock -4 80 0 minecraft:wall_sign[facing=west]{Text1:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text2:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text3:'"|||||||||||||||||||||||||||||||||||||||||||||"',Text4:'"|||||||||||||||||||||||||||||||||||||||||||||"'}
setblock -4 80 -1 minecraft:wooden_button[facing=west]
# Car - Tail Lights
setblock 3 80 -1 minecraft:wooden_button[facing=east]
setblock 3 79 0 minecraft:wall_sign[facing=east]{Text2:'"MYSTICAT"'}
setblock 3 80 1 minecraft:wooden_button[facing=east]
# Car - Racing Stripe
